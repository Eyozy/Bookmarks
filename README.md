...
![YAML to App diagram](https://github.com/darekkay/static-marks/raw/master/assets/img/workflow.svg)
...
🔖 [**View Live Demo**](https://bookmarks.eyoz.cc)

## Demo

<div align="center" class="text-center">

![Static Marks Screencast](https://raw.githubusercontent.com/darekkay/static-marks/master/assets/img/screencast.gif)
...
```shell
static-marks import browser-bookmarks.html -o bookmarks.yml
```

- [Build](#build-bookmarks-app) your bookmarks app:

```shell
static-marks build bookmarks.yml -o index.html
```

- Modify your bookmarks title:

```shell
static-marks build --title <your bookmarks title> bookmarks.yml -o index.html
```
...
```bash
static-marks build bookmarks.yml -o bookmarks.html  # Single file
static-marks build f1.yml f2.yml -o bookmarks.html  # Multiple files
static-marks build files/* -o bookmarks.html        # All files at path
```
...
This project and its contents are open source under the [MIT license](https://github.com/Eyozy/Bookmarks/blob/main/LICENSE).
